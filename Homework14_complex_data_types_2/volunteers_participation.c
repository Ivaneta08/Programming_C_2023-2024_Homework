/*
Направете списък от 2 каузи, с участници в тях, които могат да участват или не. 
За да създадете структурите, използвайте комбинация от определени (непозиционни) инициализатори и от нормални 
(позиционни инициализатори). 
*/
